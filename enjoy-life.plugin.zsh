# enjoy-life.plugin.zsh — auto-generated by build.sh, do not edit directly
...
local idx=$(( RANDOM % ${#reasons[@]} + 1 ))
local reason="${reasons[$idx]}"
reason="${(U)reason:0:1}${reason:1}"

echo "\\033[0;36m💙 ${reason}\\033[0m"
